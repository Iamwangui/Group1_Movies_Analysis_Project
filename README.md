...
~ Analysis : -We used descriptive analysis to evaluate Profit, Cost of Production, and Timing, through aggregate values of grouped column means,counts and medians./
